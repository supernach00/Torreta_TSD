...
//PWM
void PWM_set_DC(uint8_t duty_cycle); // Configura el ciclo de trabajo de la señal PWM generada por el Timer1. El argumento duty_cycle es un valor entre 0 y 100 que representa el porcentaje del ciclo de trabajo.
